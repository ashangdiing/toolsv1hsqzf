...
namespace net.callOut
{
    class Evaluation
    {
        ...
        public string recordTime = "1901-01-01 01:01:01";
        public string context="噪音扰民";
         ...
         public string toIVRHour(string time)
         {
             ...
             mm = dt.Month.ToString();//11 
             ss = dt.Second.ToString();//28 
             return yy + "年" + mm + "月" + dd + "日" + hh+"点";
         }
        public string toString(){
            return " id ： "+taskID + "名字：" + name + "时间 ： "+dateTime + "部门： "+department +"电话号码："+phoneNumber+
                "发生地点：" + accidentAddress + "评论结果：" + evaluationResult + "当前状态:" + state + "最后更新时间:" + lastUpdateTime + "投诉类容:" + context;
        }
